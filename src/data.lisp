...
especially if you feel that its point could have been made more gently."""
     ...
     :disturbing
     """Warning that a link is pornographic, disturbing, or otherwise not work
safe."""
...
;;; Positive:
 ...
 comments adds to a discussion, therefore they may regard a positive Funny vote as a proxy for Offtopic."""
     ...
     :point-taken
     """A way of acknowledging that an opponent has resolved something in his favor."""
...
field."""
     ...
     :out-of-date
     """Some comments are going to need pruning as time progresses."""
...
(pythonic-string-reader:disable-pythonic-string-syntax)
...
(defparameter *flag-labels*
  '(("Spam" "Inflammatory" "Disagree" "Dislike" "Obscene" "Disturbing" 
    ...
    ("Informative" "Insightful" "Funny" "PointTaken" "Agree" "Like")
