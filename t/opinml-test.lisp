...
(defun init-test-opinml ()
  (tt-update-page-data *testurl* (asdf:system-relative-pathname 'warflagger "t/sample.html") "text/html")
  (tt-update-page-data "https://warflagger.net/static/html/sample.html"
                       (asdf:system-relative-pathname 'warflagger "t/sample.html") "text/html")
  (let* ((opin-path (asdf:system-relative-pathname 'warflagger "t/opinions/"))
